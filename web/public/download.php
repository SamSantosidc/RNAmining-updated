    ...
    <div class="container" style='padding-top:100px'>
		...
		<h3 class="portfolio-text">Used databases</h3>
                <h4 class="text-justify text-about" style="line-height:30px;text-indent:50px">
                    <p><span class="specialchar">RNAmining</span> was validated using the datasets described in the project documentation.</p>
                </h4>
			...
			<ul style="list-style-type:circle">
                ...
                <h4 class="text-justify text-about" style="line-height:30px;text-indent:50px">
                    <p><span class="specialchar">RNAmining</span> can be run with Docker or through the installed <code>rnamining</code> command. Installation and workflow commands are documented in the project repository.</p>
                </h4>    
