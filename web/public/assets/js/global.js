...
$('body').on('submit','#formUploadFasta', function(e){
	...
	$.ajax({
	    ...
	    error: function(data){
			...
			var message = data.responseJSON && data.responseJSON.error
				? data.responseJSON.error : "The FASTA upload failed.";
	    	exec.uploadFail(message);
	    },
...
$('body').on('submit','#formData', function(e){
	...
	$.ajax({
	    ...
	    error: function(data){
			...
			var message = data.responseJSON && data.responseJSON.error
				? data.responseJSON.error : "RNAmining prediction failed.";
	    	exec.execFail(message);
